package com.github.bxy.msgs.config.datasource;
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.github.bxy"}, 修改为  basePackages = {"com.github.bxy.order.dao"} # 这个路径根据你的情况修改
 * 7. mysql.yml 中增加2个数据源的配置 spring.database.druid.master 和 spring.database.druid.slave
 * <p>
 * 完成上述修改后， 位于com.github.bxy.product.dao 包下的dao 将操作  master 库， com.github.bxy.order.dao中的dao 将操作slave库
 *
 * @author bxy
