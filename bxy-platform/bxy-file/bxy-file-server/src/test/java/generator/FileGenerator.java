...
//                        Arrays.asList("f_.*"));
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bxy_file_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bxy-platform/bxy-file");
//
...
////                EntityFiledType.builder().name("httpMethod").packagePath("com.github.bxy.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//        ));
