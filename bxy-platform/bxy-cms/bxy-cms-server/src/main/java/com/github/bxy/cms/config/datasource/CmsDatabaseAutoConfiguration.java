...
import com.github.bxy.database.datasource.BaseDatabaseConfiguration;
 ...
 * 一个服务如何配置多数据源？
 * <p>
 * 1. 本类中的 basePackages = {"com.github.bxy"}, 修改为  basePackages = {"com.github.bxy.product.dao"}  # 这个路径根据你的情况修改
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.github.bxy"}, 修改为  basePackages = {"com.github.bxy.cms.dao"} # 这个路径根据你的情况修改
 * 7. mysql.yml 中增加2个数据源的配置 spring.database.druid.master 和 spring.database.druid.slave
 * <p>
 * 完成上述修改后， 位于com.github.bxy.product.dao 包下的dao 将操作  master 库， com.github.bxy.cms.dao中的dao 将操作slave库
 *
 * @author bxy
...
@MapperScan(
        ...
        sqlSessionFactoryRef = CmsDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class CmsDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public CmsDatabaseAutoConfiguration(MybatisPlusProperties properties,
