package com.github.bxy.zuul.filter.pre;

import java.util.List;

import com.github.bxy.filter.BaseFilter;
 ...
 *
 * 使用场景:
 * 用户bxy，在启动 bxy-authority-server 时， 将改成 spring.application.name: bxy-authority-server-bxy ，
 * 通过在请求每个请求头中增加 serviceSuffix=bxy , 请求就能通过网关路由到 bxy 的机器上
 *
 * 该过滤器请勿使用在正式环境
 * @author bxy
 */
