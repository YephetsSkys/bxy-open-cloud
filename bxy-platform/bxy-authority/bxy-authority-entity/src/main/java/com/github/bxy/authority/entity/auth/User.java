...
import static com.github.bxy.common.constant.InjectionFieldConstants.*;
...
public class User extends Entity<Long> {
     ...
     * #c_core_org
     *
     * @InjectionField(api = ORG_ID_CLASS, method = ORG_ID_METHOD) RemoteData<Long, com.github.bxy.authority.entity.core.Org>
     */
    @ApiModelProperty(value = "组织ID")
    @TableField("org_id")
    @InjectionField(api = ORG_ID_CLASS, method = ORG_ID_METHOD)
    private RemoteData<Long, com.github.bxy.authority.entity.core.Org> org;

    /**
     * 岗位ID
     * #c_core_station
     *
     * @InjectionField(api = STATION_ID_CLASS, method = STATION_ID_METHOD) RemoteData<Long, com.github.bxy.authority.entity.core.Station>
     */
    @ApiModelProperty(value = "岗位ID")
    @TableField("station_id")
    @InjectionField(api = STATION_ID_CLASS, method = STATION_ID_METHOD)
    private RemoteData<Long, com.github.bxy.authority.entity.core.Station> station;
    ...
    public User(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
                String account, String name, RemoteData<Long, com.github.bxy.authority.entity.core.Org> orgId, RemoteData<Long, com.github.bxy.authority.entity.core.Station> stationId, String email,
