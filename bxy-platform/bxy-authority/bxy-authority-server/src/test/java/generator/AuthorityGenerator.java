...
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bxy_authority_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bxy-platform/bxy-authority");
//
...
//                        .packagePath("com.github.bxy.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//                , EntityFiledType.builder().name("httpMethod").table("c_auth_resource")
//                        .packagePath("com.github.bxy.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//                , EntityFiledType.builder().name("dsType").table("c_auth_role")
//                        .packagePath("com.github.bxy.database.mybatis.auth.DataScopeType").gen(GenerateType.IGNORE).build()
//        ));
