...
import com.github.bxy.authority.dao.defaults.InitDbMapper;
...
public class InitSystemServiceImpl implements InitSystemService {
     ...
     * 需要初始化的库
     */
    private final static List<String> INIT_DATABASE_LIST = Arrays.asList("bxy_base");
    @Resource(name = "masterDruidDataSource")
    private DataSource dataSource;
    @Autowired
    private InitDbMapper initDbMapper;

    @Value("${bxy.mysql.database}")
