...
import com.github.bxy.authority.dto.auth.*;
import com.github.bxy.authority.entity.auth.Role;
...
import com.github.bxy.authority.service.auth.RoleService;
import com.github.bxy.authority.service.auth.UserService;
import com.github.bxy.authority.service.core.OrgService;
import com.github.bxy.authority.service.core.StationService;
...
import com.github.bxy.sms.enumeration.VerificationCodeType;
import com.github.bxy.user.feign.UserQuery;
import com.github.bxy.user.model.SysOrg;
import com.github.bxy.user.model.SysRole;
import com.github.bxy.user.model.SysStation;
import com.github.bxy.user.model.SysUser;
...
import static com.github.bxy.common.constant.BizConstant.DEMO_ORG_ID;
import static com.github.bxy.common.constant.BizConstant.DEMO_STATION_ID;
...
//        }
    ...
    public R<LoginDTO> reload(@RequestParam Long userId) throws BizException {
        ...
        List<com.github.bxy.authority.entity.auth.Resource> resourceList = this.resourceService.findVisibleResource(ResourceQueryDTO.builder().userId(userId).build());
        List<String> permissionsList = resourceList.stream().map(com.github.bxy.authority.entity.auth.Resource::getCode).collect(Collectors.toList());
